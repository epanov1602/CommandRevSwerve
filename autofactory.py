...
class AutoFactory(object):
    ...
    def init(self):
        ...
        self.startPos.addOption("3: ML", (7.189, 4.40, 180))  # (x, y, headingDegrees)
        self.startPos.setDefaultOption("4: MID", (7.189, 4.025, 180))  # (x, y, headingDegrees)
        ...
        self.autoApproachSpeed.addOption("0.93", 0.93)

...
class MAXSwerveModule:
    ...
    def stop(self):
        ...
        """
        self.drivingPIDController.setReference(0, CANSparkMax.ControlType.kVelocity)
        self.turningPIDController.setReference(self.turningEncoder.getPosition(), CANSparkMax.ControlType.kPosition)

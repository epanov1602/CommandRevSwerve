...
class ModuleConstants:
    ...
    kWheelDiameterMeters = units.inchesToMeters(4) * 0.83  # MK4i/MK4n: 4 inches, MAXSwerve: 3 inches
...
class RobotCameraLocations:
    ...
    kRear = Pose2d(Translation2d(x=+0.05, y=-0.40), Rotation2d.fromDegrees(-180))

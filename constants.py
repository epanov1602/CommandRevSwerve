...
class ModuleConstants:
    ...
    kTurningReductionRatio = 150.0/7.0  # 287 / 11.0 would be for MK5n
    ...
    kTurningP = 1.0  # can be dialed down if you see oscillations in the turning motor
    kTurningI = 0
    kTurningD = 0
    kTurningFF = 0
    kTurningMinOutput = -1
